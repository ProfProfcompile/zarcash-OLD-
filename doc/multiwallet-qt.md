...
In order to support loading of multiple wallets in zarcash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zarcash.cpp.
...
Changes to zarcash.cpp
----------------------
zarcash.cpp is the entry point into zarcash-qt, and as such, will require some minor modifications to provide hooks for
