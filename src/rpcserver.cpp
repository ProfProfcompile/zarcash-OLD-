...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "ZARCASH server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ZARCASH features */
        {"zarcash", "masternode", &masternode, true, true, false},
        {"zarcash", "masternodelist", &masternodelist, true, true, false},
        {"zarcash", "mnbudget", &mnbudget, true, true, false},
        {"zarcash", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"zarcash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zarcash", "mnsync", &mnsync, true, true, false},
        {"zarcash", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"zarcash", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use zarcashd, or the -server option to zarcash-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> zarcash-cli " + methodname + " " + args + "\n";
}
