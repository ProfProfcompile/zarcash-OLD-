/* src/config/zarcash-config.h.  Generated from zarcash-config.h.in by configure.  */
/* src/config/zarcash-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ZARCASH_CONFIG_H

#define ZARCASH_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://zarcashpay.network"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ZARCASH Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ZARCASH Core 1.2.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "zarcash"
