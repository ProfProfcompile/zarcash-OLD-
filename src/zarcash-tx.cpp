...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ZARCASH Core zarcash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  zarcash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zarcash transaction") + "\n" +
                               "  zarcash-tx [options] -create [commands]   " + _("Create hex-encoded zarcash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded zarcash transaction
