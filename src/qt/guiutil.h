...
/** Utility functions used by the ZARCASH Qt UI.
 */
namespace GUIUtil
{
...
// Render ZARCASH addresses in monospace font
...
// Parse "zarcash:" URI into recipient object, return true on successful parsing
