                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ZARCASH-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ZARCASH address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zarcash: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ZARCASH Core"), this);
    aboutAction->setStatusTip(tr("Show information about ZARCASH Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ZARCASH"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ZARCASH addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ZARCASH addresses"));
    ...
    openAction->setStatusTip(tr("Open a ZARCASH: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ZARCASH Core help message to get a list with possible ZARCASH command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ZARCASH Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ZARCASH network", "", count));
}
...
{
    QString strTitle = tr("ZARCASH Core"); // default title
